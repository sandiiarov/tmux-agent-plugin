...
- Improved the fzf popup preview to preserve ANSI colors, join tmux physical wraps into logical lines, avoid fzf wrap markers, start preview at the top, support `C-n`/`C-p`, `C-o` jump, escape close, extra fzf theme options, and refresh on demand.
