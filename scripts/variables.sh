...
POPUP_SHOW_STATUS_ICON_OPTION="@agent-status-popup-show-status-icon"
POPUP_SHOW_AGENT_ICON_OPTION="@agent-status-popup-show-agent-icon"
POPUP_SHOW_AGENT_LABEL_OPTION="@agent-status-popup-show-agent-label"
...
DEFAULT_POPUP_SHOW_STATUS_ICON="on"
DEFAULT_POPUP_SHOW_AGENT_ICON="auto"
DEFAULT_POPUP_SHOW_AGENT_LABEL="off"
